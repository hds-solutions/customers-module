...
mix.options({
    fileLoaderDirs: {
        images: 'customers-module/assets/images',
        fonts: 'customers-module/assets/fonts',
    }
});
...
mix
     ...
     ** *********************** **/
    .js('resources/assets/js/app.js',       'customers-module/assets/js')
    .sass('resources/assets/sass/app.scss', 'customers-module/assets/css')
    .copy('resources/assets/images',        public+'/customers-module/assets/images')
